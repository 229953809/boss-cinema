...
public class SettingEnhanceFragment extends BaseFragment {
    ...
    private void setDetailInteractionMode(View view) {
        new MaterialAlertDialogBuilder(requireActivity()).setTitle(R.string.setting_detail_open_mode).setNegativeButton(R.string.dialog_negative, null).setSingleChoiceItems(getDetailInteractionModes(), getDetailInteractionModeIndex(), (dialog, which) -> {
